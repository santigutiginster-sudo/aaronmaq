...
export default async function SubcategoriaPage({ params }: Props) {
  ...
  const productosFiltrados = productos.filter(
    (producto) =>
      producto.categoria === nombreSubcategoria
  );
  ...
  return (
    <main className="min-h-screen bg-white py-20">
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        {/* Flecha para volver a la categoría */}
        <Link
        ...
        >
          ...
          <span className="font-medium">
            Volver a {categoria.replaceAll("-", " ")}
          </span>
        </Link>

        {/* Título */}
        <h1 className="mt-8 text-5xl font-bold text-slate-900 capitalize">
          {nombreSubcategoria}
        </h1>
