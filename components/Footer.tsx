...
return ( <footer className="mt-16 border-t border-slate-200 bg-white text-slate-700">
    ...
    <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <div className="lg:text-right">
        ...
        <div className="flex items-center gap-5 lg:justify-end">
          ...
          {/* INSTAGRAM */}
          <a
            href="https://www.instagram.com/aaron_maq/"
            target="_blank"
          ...
          {/* FACEBOOK */}
          <a
            href="https://www.facebook.com/MaquinasAaronMaq/?locale=es_LA"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Facebook"
            className="transition-transform duration-200 hover:scale-110"
          ...
          {/* TIKTOK */}
          <a
            href="https://www.tiktok.com/@aaronmaq_troqueladoras"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="TikTok"
            className="transition-transform duration-200 hover:scale-110"
